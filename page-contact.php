...
<section class="relative bg-main section fade">
	<div class="bg-white absolute top-0 right-0 w-[561px] z-1 h-full hidden wp-xl:block">

	</div>
	<div class="2xl:max-w-[1440px] 2xl:mx-auto flex flex-col flex-wrap lg:flex-row z-10 relative">
		<aside class="pt-[55px] pb-[105px] lg:pt-[115px] lg:pb-[205px] text-white bg-main px-[14px] lg:px-[82px] w-full lg:w-1/2">
			<span class="mb-6 text-lg text-white fade fade-delay"> CONTACT US </span>
			<h1 class="text-[35px] leading-[45px] lg:text-[70px] lg:leading-[90px] mb-[35px] lg:mb-[70px] font-bold text-white fade fade-delay"> Get in Touch </h1>
			<div class="form-contact">
				<?php echo do_shortcode('[gravityform id="2" title="false"]') ?>
			</div>
		</aside>

		<div class="pt-[55px] pb-[105px] lg:pt-[151px] lg:pb-[205px] px-[14px] lg:px-[123px] flex flex-col items-center xl:items-start w-full lg:w-1/2 bg-white">
			<span class="text-[35px] leading-[45px] mb-[35px] lg:mb-[70px] lg:text-[70px] lg:leading-[90px] font-bold text-black fade fade-delay"> Locations </span>
			<?php if ( isset( $args['location_repeaters'] ) && $args['location_repeaters'] ): ?>
				...
				<?php foreach( $args['location_repeaters'] as $office_location ): ?>
					<li class="text-lg leading-[40px] mb-3 list-none flex flex-col xl:flex-row gap-5 fade fade-delay">
