...
if ( ! get_field( 'block_preview' ) ) {
	...
	<section 	class="w-full h-full px-[14px] py-[50px] xl:px-[0] lg:py-[100px] bg-lightBlue"
				...
				<div class="flex flex-col items-center justify-center w-full mb-[22px]">
					...
					<h2 class="mt-0 mb-0 text-center text-[40px] font-bold leading-[60px] max-w-[1060px]"><?php echo esc_attr( $title ); ?></h2>
				</div>
				<?php endif; ?>
				<?php if( $recent_transactions ):  ?>
					<div
							...
							data-splide='{"type":"loop", "width": "1060px", "perPage":3, "pagination": false, "focus": "center", "updateOnMove": true, "trimSpace": "move", "gap": 0}'
						>
						...
						<div class="pb-[58px] px-[14px] md:px-[54px] lg:px-[108px]">
								...
								<ul class="splide__list">
									<?php foreach ( $recent_transactions as $post ): ?>
										...
										<li class="splide__slide">
											<a
												class="px-[63px] py-[65px] bg-white flex flex-col items-center justify-center gap-[23px] h-full no-underline"
												...
												<span class="text-[20px] leading-[30px] text-center"><?php echo esc_attr( $transaction_action_text ); ?></span>
