...
if ( ! get_field( 'block_preview' ) ) {
	?>
	<section 	class="w-full h-full px-[14px] lg:px-[82px] flex flex-col justify-center items-center"
				...
				<?php if ($selected_sectors):?>
					<ul class="grid w-full sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 pt-[88px] pb-[62px]">
